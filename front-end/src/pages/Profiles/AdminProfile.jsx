...
import {
    ...
    FaCog, FaBell, FaSignOutAlt, FaSchool, FaUsers, FaUserCheck
} from 'react-icons/fa';
import './Profiles.css';
    ...
    return (
        <div className="up-page">
            <div className="up-container">
                <motion.div
                    className="up-header admin-theme"
                    initial={{ opacity: 0, scale: 0.98 }}
                    animate={{ opacity: 1, scale: 1 }}
                >
                    <div className="up-header-content">
                        <div className="up-avatar-big"><FaUserTag /></div>
                        <div className="up-info-text">
                            <h1 className="up-name">{userData.name}</h1>
                            <p className="up-role-badge"><FaUserTag /> {userData.role}</p>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="up-grid">
                    <motion.div className="up-sidebar" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
                        <div className="up-side-card">
                            <h3 className="up-side-title">Admin Console</h3>
                            <div className="up-side-links">
                                <button className="up-side-link active"><FaUser /> My Profile</button>
                                <button className="up-side-link"><FaUserCheck /> Approve Teachers</button>
                                <button className="up-side-link"><FaUsers /> Student Directory</button>
                                <button className="up-side-link"><FaBell /> Announcements</button>
                    ...
                    <div className="up-main">
                        ...
                        <motion.div className="up-section" variants={fadeUp} initial="initial" animate="animate" transition={{ delay: 0.2 }}>
                            <h2 className="up-sec-title">Campus Activity</h2>
                            <div className="up-dash-grid">
                                <motion.div className="up-dash-card" whileHover={{ y: -5 }}>
                                    <FaUserCheck />
                                    <div><h3>12 Pending</h3><p>Teacher applications to review.</p></div>
                                </motion.div>
                                <motion.div className="up-dash-card" whileHover={{ y: -5 }}>
                                    <FaSchool />
                                    <div><h3>Campus A</h3><p>Manage currently active campus.</p></div>
                                </motion.div>
                            </div>
                        </motion.div>
                    </div>
